...
| Wave 2 — Pass D (Evidence) | Done | benchmarks/strengths/weaknesses with citations across all entities |
| Wave 2 — Pass E (Views) | Done | all 4 cross-cuts (by-layer, by-task, by-hardware, by-license) wired to entities with one-line justifications |
