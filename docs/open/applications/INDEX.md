...
| [Gemma Chat](gemma-chat.md) | ammaarreshi | MIT | Desktop app (Electron) | Chat + coding (Gemma-specific) | Apple Silicon via MLX or Ollama |
| [Gemma Gem](gemma-gem.md) | kessler | Apache-2.0 | Browser extension (Chrome/Edge) | Browser chat (Gemma-specific) | WebGPU, on-device; borderline adoption |
