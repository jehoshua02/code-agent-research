...
| [Hunyuan](hunyuan.md) | Tencent | Hunyuan-0.5B, Hunyuan-1.8B, Hunyuan-4B, Hunyuan-7B-Instruct, Hunyuan-MT-7B, Hunyuan-A13B-Pretrain, Hunyuan-A13B-Instruct, Hunyuan-A13B-Instruct-FP8, Hunyuan-A13B-Instruct-GPTQ-Int4, Hunyuan-Large-389B | Tencent Hunyuan License | 262K | Proprietary Tencent license — not Apache 2.0; minimum 2× RTX 4090 even at Q4 |
...
| [Nemotron](nemotron.md) | NVIDIA | Nemotron-Mini-4B-Instruct, Nemotron-3-Nano-4B, Llama-3.1-Nemotron-70B-Instruct, Llama-3.1-Nemotron-70B-Reward, Nemotron-4-340B-Base, Nemotron-4-340B-Instruct, Nemotron-4-340B-Reward | NVIDIA Open Model License | 131K | Nemotron-4-340B has only 4K context; Llama-3.1-Nemotron-70B inherits 128K from Llama 3.1 |
